...
const TOOLS: ToolDef[] = [
  ...
  { name: "find_unused_assets", description: "Project assets unreachable from roots (cleanup candidates).", schema: { scope: z.string().optional(), includeScripts: z.boolean().optional() } },
